...
- **人形机器人**:[1X World Model](https://jeffliulab.com/ai-notes/08_World_Models/06_Applications/1X_World_Model)、[人形 form factor](../../08_Humanoids/index.md)
- **行为分层**:[Advanced RL](https://jeffliulab.com/ai-notes)
