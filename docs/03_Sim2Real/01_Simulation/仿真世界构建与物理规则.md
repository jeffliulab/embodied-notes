...
这篇笔记讨论的不是单个资产，而是资产如何组成世界。它位于 [仿真资产](仿真资产.md) 之后、[仿真平台](simulation_platforms.md) 之下、[Sim2Real](../../02_Robot_Learning/02_Methods/Sim2Real.md) 之前：前者告诉你“零件是什么”，本文告诉你“零件如何拼成一个可运行、可训练、可迁移的宇宙”。
...
[虚拟世界仿真引擎](https://jeffliulab.github.io/ai-notes/05_AI_Agents/07_Virtual_Embodied_Agents/虚拟世界仿真引擎/) 里的 Smallville 看似是社会仿真，不是机器人平台，但它有一个非常重要的工程思想：**世界不是一张图，而是一棵带语义的树。**
...
本节不重复 [动力学](../../00_Robotics/02_Classical_Robotics/动力学.md) 中的系统推导，而聚焦于“仿真器如何实现一个刚体世界的最小动力学闭环”。
...
与 [Sim2Real](../../02_Robot_Learning/02_Methods/Sim2Real.md) 中总论一致，世界层真正要落的是：
...
- 格式基础和开发工具，见 [开发工具链](../03_Ecosystem/开发工具链.md)。
- 随机化、系统辨识和迁移总论，见 [Sim2Real](../../02_Robot_Learning/02_Methods/Sim2Real.md)。
- 动力学和控制的理论基础，见 [动力学](../../00_Robotics/02_Classical_Robotics/动力学.md) 与 [控制理论](../../00_Robotics/02_Classical_Robotics/控制理论.md)。
- 若关心学习式世界模型和生成式仿真，可继续看 [世界模型与视频生成](../../02_Robot_Learning/01_Foundations/世界模型与视频生成.md) 与 [空间智能与学习式仿真](https://jeffliulab.github.io/ai-notes/01_AI/03_Frontiers/03_World_Models/空间智能与学习式仿真/)。
...
- [Sim2Real](../../02_Robot_Learning/02_Methods/Sim2Real.md)
