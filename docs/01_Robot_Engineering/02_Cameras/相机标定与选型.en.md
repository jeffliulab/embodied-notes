...
### Radial Distortion Model Curves

<!-- SVG-DESIGN-NOTES
Type: B (几何 — 径向畸变多项式曲线)
Q0: 标定的本质是拟合畸变曲线 $r' = r(1 + k_1 r^2 + k_2 r^4 + k_3 r^6)$；广角镜头 $k_1 < 0$ 让边缘向内收缩 (桶形),长焦 $k_1 > 0$ 让边缘外撑 (枕形);单 $k_1$ 在 $r > 0.6$ 已发散,必须加 $k_2/k_3$ 才覆盖鱼眼。
Q1: x = 归一化半径 r ∈ [0, 1.0]; y = 畸变后半径 r' — 三条曲线 (ideal r' = r 灰虚线 / 桶形 k1=-0.3 蓝实 / 枕形 k1=+0.3 红实 / 鱼眼 k1=-0.45,k2=+0.15 强弯)
Q2: 去掉标题:四条曲线的相对走向 — DNA 是径向畸变多项式族
Q3: 删了 14 个等大决策方框、12 根箭头、原选型流程图 (与"标定"主题不直接相关)
Q4: 各曲线 label 直接放曲线右端
Q5: 全 var(--dia-*)
-->
<div class="diagram">
<svg viewBox="0 0 720 380" xmlns="http://www.w3.org/2000/svg">
  <text x="360" y="26" text-anchor="middle" font-family="Fraunces, Georgia, serif" font-style="italic" font-weight="600" font-size="17" fill="var(--dia-stroke)">Radial distortion polynomial — curve family for different k</text>
  <text x="360" y="46" text-anchor="middle" font-family="Fraunces, Georgia, serif" font-style="italic" font-size="12" fill="var(--dia-stroke-soft)">r' = r (1 + k₁r² + k₂r⁴ + k₃r⁶) · normalized image radius</text>

  <!-- axes: x in [0..1] maps to [80..680]; y in [0..1.4] maps to [320..60] -->
  ...
  <g font-family="JetBrains Mono, monospace" font-size="10" fill="var(--dia-stroke-soft)">
    <line x1="80"  y1="318" x2="80"  y2="324"/><text x="80"  y="338" text-anchor="middle">0</text>
    <line x1="230" y1="318" x2="230" y2="324"/><text x="230" y="338" text-anchor="middle">0.25</text>
    <line x1="380" y1="318" x2="380" y2="324"/><text x="380" y="338" text-anchor="middle">0.5</text>
    <line x1="530" y1="318" x2="530" y2="324"/><text x="530" y="338" text-anchor="middle">0.75</text>
    <line x1="680" y1="318" x2="680" y2="324"/><text x="680" y="338" text-anchor="middle">1.0</text>

    <line x1="76" y1="320" x2="84" y2="320"/><text x="72" y="324" text-anchor="end">0</text>
    <line x1="76" y1="271" x2="84" y2="271"/><text x="72" y="275" text-anchor="end">0.25</text>
    <line x1="76" y1="223" x2="84" y2="223"/><text x="72" y="227" text-anchor="end">0.5</text>
    <line x1="76" y1="174" x2="84" y2="174"/><text x="72" y="178" text-anchor="end">0.75</text>
    <line x1="76" y1="125" x2="84" y2="125"/><text x="72" y="129" text-anchor="end">1.0</text>
    <line x1="76" y1="77"  x2="84" y2="77" /><text x="72" y="81"  text-anchor="end">1.25</text>
  </g>
  <text x="380" y="358" text-anchor="middle" font-family="Fraunces, Georgia, serif" font-style="italic" font-size="11" fill="var(--dia-stroke-soft)">normalized radius r</text>
  <text x="22" y="190" text-anchor="middle" font-family="Fraunces, Georgia, serif" font-style="italic" font-size="11" fill="var(--dia-stroke-soft)" transform="rotate(-90 22 190)">distorted radius r'</text>

  <!-- ideal identity r' = r dashed -->
  <line x1="80" y1="320" x2="680" y2="125" stroke="var(--dia-stroke-soft)" stroke-width="1" stroke-dasharray="4 3"/>
  <text x="600" y="148" font-family="Fraunces, Georgia, serif" font-style="italic" font-size="11" fill="var(--dia-stroke-soft)">ideal r' = r</text>

  <!-- barrel: k1=-0.3 -->
  <!-- r' = r(1 + (-0.3)r^2). Sampled: r=0→0, .25→.25(1-.01875)=.245, .5→.5(1-.075)=.463, .75→.75(1-.169)=.624, 1.0→1.0(1-.3)=.700 -->
  <path d="M 80 320 C 230 271 350 232 450 199 C 530 175 600 158 680 173" stroke="var(--dia-blue)" stroke-width="2.2" fill="none"/>
  <circle cx="680" cy="173" r="3.5" fill="var(--dia-blue)"/>
  <text x="690" y="178" font-family="Fraunces, Georgia, serif" font-size="11" fill="var(--dia-blue)">barrel k₁=−0.3</text>

  <!-- pincushion: k1=+0.3 -->
  <!-- r' = r(1+0.3 r^2): .25→.255, .5→.519, .75→.876, 1.0→1.30 -->
  <path d="M 80 320 C 230 270 350 225 450 175 C 530 135 600 100 680 67" stroke="var(--dia-accent)" stroke-width="2.2" fill="none"/>
  <circle cx="680" cy="67" r="3.5" fill="var(--dia-accent)"/>
  <text x="600" y="60" font-family="Fraunces, Georgia, serif" font-size="11" fill="var(--dia-accent)">pincushion k₁=+0.3</text>

  <!-- fisheye: k1=-0.45, k2=+0.15 -->
  <!-- r=.5: 0.5(1-0.45*.25+0.15*.0625)=0.5*0.897=0.449
        r=.75: .75(1-.45*.5625+.15*.316)=.75*0.794=0.596
        r=1.0: 1*(1-0.45+0.15)=0.7 -->
  <path d="M 80 320 C 250 290 360 246 450 218 C 540 192 610 175 680 203" stroke="var(--dia-green)" stroke-width="2.2" fill="none"/>
  <circle cx="680" cy="203" r="3.5" fill="var(--dia-green)"/>
  <text x="555" y="225" font-family="Fraunces, Georgia, serif" font-size="11" fill="var(--dia-green)">fisheye k₁=−0.45,k₂=+0.15</text>

  <!-- annotation: divergence danger zone -->
  <line x1="475" y1="60" x2="475" y2="320" stroke="var(--dia-gold)" stroke-width="0.7" stroke-dasharray="2 3" opacity="0.55"/>
  <text x="481" y="76" font-family="Fraunces, Georgia, serif" font-style="italic" font-size="10" fill="var(--dia-gold)">r &gt; 0.6 region:</text>
  <text x="481" y="90" font-family="Fraunces, Georgia, serif" font-style="italic" font-size="10" fill="var(--dia-gold)">single k₁ diverges,</text>
  <text x="481" y="104" font-family="Fraunces, Georgia, serif" font-style="italic" font-size="10" fill="var(--dia-gold)">needs k₂/k₃</text>
</svg>
</div>
<p class="figure-caption">Figure 1 — Calibration is geometrically a polynomial fit on the r-r' plane; the wider the lens, the more negative $k_1$, and the more high-order terms are needed to tame the divergence at the edges.</p>
...
See: [Calibration and System Integration](../../08_Embodied_Intelligence/09_Deployment/标定与系统集成.md) for more on calibration workflows in actual deployment.
