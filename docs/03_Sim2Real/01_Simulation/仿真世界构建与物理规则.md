...
- 若关心学习式世界模型和生成式仿真，可继续看 [世界模型与视频生成](../../02_Robot_Learning/01_Foundations/世界模型与视频生成.md) 与 [空间智能与学习式仿真](https://jeffliulab.com/ai-notes/08_World_Models/04_3D_Spatial/空间智能与学习式仿真)。
