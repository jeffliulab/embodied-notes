...
>
> **Difficulty**: Advanced
> **Prerequisites**: [VLA Models](VLA模型.en.md), [π0](Pi0_Physical_Intelligence.en.md), [RT-2 / OpenVLA](RT2_OpenVLA.en.md)
...
- **Same section**: [VLA Models](VLA模型.en.md), [π0](Pi0_Physical_Intelligence.en.md), [Octo](Octo_Foundation_Policy.en.md), [RT-2 / OpenVLA](RT2_OpenVLA.en.md), [RDT-1B](RDT_1B.en.md)
- **Humanoid robots**: [1X World Model](../../01_AI/03_Frontiers/03_World_Models/1X_World_Model.en.md), [Humanoid form factor](../08_Robot_Forms/index.en.md)
- **Behavior hierarchies**: [Advanced RL](../../04_Reinforcement_Learning/05_Advanced_RL/index.en.md)
