...
The combination of motion planning and reinforcement learning is a hot research direction (see [Reinforcement Learning for Robotics](../04_Robot_Learning/强化学习在机器人中的应用.md) for details).
