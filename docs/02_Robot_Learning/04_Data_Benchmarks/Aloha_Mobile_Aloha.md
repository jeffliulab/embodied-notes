...
>
> **难度**:Intermediate
> **前置知识**:[ACT 模型](../02_Methods/ACT模型.md)、[VLA 模型](../01_Foundations/VLA模型.md)、[遥操作](遥操作与数据收集.md)
> **后续阅读**:[π0](../03_Models/Pi0_Physical_Intelligence.md)、[UMI](UMI_Universal_Manipulation_Interface.md)
...
- **同节**:[ACT 模型](../02_Methods/ACT模型.md)、[VLA 模型](../01_Foundations/VLA模型.md)、[DROID](DROID_Dataset.md)、[UMI](UMI_Universal_Manipulation_Interface.md)、[π0](../03_Models/Pi0_Physical_Intelligence.md)
- **数据收集**:[遥操作与数据收集](遥操作与数据收集.md)
- **机器人形态**:[双臂机器人](../../08_Humanoids/humanoid_robot.md)
