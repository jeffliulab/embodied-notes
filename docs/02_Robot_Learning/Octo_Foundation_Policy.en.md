...
>
> **Difficulty**: Advanced
> **Prerequisites**: [VLA Models](VLA模型.en.md), [RT-2 / OpenVLA](RT2_OpenVLA.en.md), [Diffusion Policy](../04_Robot_Learning/扩散策略.en.md)
...
- **Same section**: [VLA Models](VLA模型.en.md), [RT-2 / OpenVLA](RT2_OpenVLA.en.md), [π0](Pi0_Physical_Intelligence.en.md), [RDT-1B](RDT_1B.en.md), [ACT Model](ACT模型.en.md)
- **Datasets**: [Open X-Embodiment](数据集与Benchmark.en.md), [DROID Dataset](DROID_Dataset.en.md)
- **Learning methods**: [Diffusion Policy](../04_Robot_Learning/扩散策略.en.md), [Imitation Learning](../04_Robot_Learning/模仿学习.en.md)
