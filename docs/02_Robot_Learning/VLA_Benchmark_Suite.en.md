...
> **Prerequisites**: [VLA Models](VLA模型.en.md), [π0](Pi0_Physical_Intelligence.en.md), [Octo](Octo_Foundation_Policy.en.md)
> **Further reading**: [Helix](Helix_Figure_AI.en.md), [DROID](DROID_Dataset.en.md)
...
- **Same section**: [VLA Models](VLA模型.en.md), [π0](Pi0_Physical_Intelligence.en.md), [OpenVLA](RT2_OpenVLA.en.md), [Octo](Octo_Foundation_Policy.en.md), [Helix](Helix_Figure_AI.en.md)
- **Data**: [DROID](DROID_Dataset.en.md), [Open X-Embodiment](数据集与Benchmark.en.md)
- **WM evaluation**: [WM Eval Benchmarks](../../01_AI/03_Frontiers/03_World_Models/WM_Eval_Benchmarks.en.md)
