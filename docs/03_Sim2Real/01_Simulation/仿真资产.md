...
这篇笔记专门回答资产层的问题：**仿真里到底有哪些资产，它们如何被建模、制作、导入、管理、验证，并最终变成一个可训练、可调试、可迁移的仿真世界。** 关于平台选型见 [仿真平台](simulation_platforms.md)，关于世界组织和物理规则见 [仿真世界构建与物理规则](仿真世界构建与物理规则.md)，关于格式语法基础见 [开发工具链](../03_Ecosystem/开发工具链.md)。
...
| URDF/MJCF/SDF/USD 语法 | 不做基础语法教程，重点讲这些格式在资产工程中的表达能力 | [开发工具链](../03_Ecosystem/开发工具链.md) |
| 控制、动力学、接触理论 | 只在资产参数需要时做最小引用 | [控制理论](../../00_Robotics/02_Classical_Robotics/控制理论.md), [动力学](../../00_Robotics/02_Classical_Robotics/动力学.md) |
| Sim2Real | 只讨论资产如何支持随机化和现实对齐 | [Sim2Real](../../02_Robot_Learning/02_Methods/Sim2Real.md) |
...
如果计划做 [Sim2Real](../../02_Robot_Learning/02_Methods/Sim2Real.md)，视觉资产最好天然支持：
...
[开发工具链](../03_Ecosystem/开发工具链.md) 已经介绍了 `<link>`, `<joint>`, `<inertial>`, `<sensor>` 等基础元素。本篇更关心另一层问题：
...
| 自碰撞是否正确 | 全关节扫描 |
| 末端坐标是否正确 | TCP 对齐测试 |
| 传感器外参 | 在 [标定与系统集成](../02_Deployment/标定与系统集成.md) 流程中验证 |
...
真正的系统标定流程见 [标定与系统集成](../02_Deployment/标定与系统集成.md)。
...
- 想看 URDF/MJCF/SDF 的基础语法和开发工具，看 [开发工具链](../03_Ecosystem/开发工具链.md)。
- 想理解资产如何进入可训练世界，以及时间步、接触求解、随机化如何生效，看 [仿真世界构建与物理规则](仿真世界构建与物理规则.md)。
- 想从 Sim2Real 角度理解为什么纹理、灯光、传感器噪声要做成可控资产，看 [Sim2Real](../../02_Robot_Learning/02_Methods/Sim2Real.md)。
- 想把机器人资产与控制接口联系起来，看 [控制理论](../../00_Robotics/02_Classical_Robotics/控制理论.md)。
