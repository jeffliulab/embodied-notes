...
> Related notes: [Model Roadmap](模型发展路线图.en.md) | [Imitation Learning](../04_Robot_Learning/模仿学习.en.md) | [VLA Models](VLA模型.en.md) | [Open-Source Model Summary](开源模型汇总.en.md) | [Teleoperation and Data Collection](../04_Robot_Learning/遥操作与数据收集.en.md)
...
- to the left: [Imitation Learning](../04_Robot_Learning/模仿学习.en.md)
- to the right: [VLA Models](VLA模型.en.md), [Model Roadmap](模型发展路线图.en.md)
