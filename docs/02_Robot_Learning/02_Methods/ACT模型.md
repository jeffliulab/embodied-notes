...
> 相关笔记：[模型发展路线图](../01_Foundations/模型发展路线图.md) | [模仿学习](模仿学习.md) | [VLA模型](../01_Foundations/VLA模型.md) | [开源模型汇总](../03_Models/开源模型汇总.md) | [遥操作与数据收集](../04_Data_Benchmarks/遥操作与数据收集.md)
...
- 向左看：[模仿学习](模仿学习.md)
- 向右看：[VLA模型](../01_Foundations/VLA模型.md)、[模型发展路线图](../01_Foundations/模型发展路线图.md)
