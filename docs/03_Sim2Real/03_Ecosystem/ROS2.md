...
> 本文是对 ROS2 系统架构及关键软件栈的深度技术笔记。关于 ROS 历史与基本安装，请参阅 [仿真平台](../01_Simulation/simulation_platforms.md) 中的 ROS 小节。
...
更多运动规划理论请参阅 [运动规划](../../00_Robotics/02_Classical_Robotics/运动规划.md)。
...
- 相关笔记：[运动规划](../../00_Robotics/02_Classical_Robotics/运动规划.md) | [SLAM](../../00_Robotics/02_Classical_Robotics/SLAM.md) | [开发工具链](开发工具链.md)
