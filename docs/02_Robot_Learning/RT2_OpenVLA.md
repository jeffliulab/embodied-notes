...
>
> **难度**：Advanced
> **前置知识**：[VLA 模型综述](VLA模型.md)、[多模态大模型](../../03_Foundation_Models/05_Multimodal/MLLMs.md)、[扩散策略](../04_Robot_Learning/扩散策略.md)
> **后续阅读**：[π0 / RDT-1B](../04_Robot_Learning/index.md)、[Sim2Real](../04_Robot_Learning/Sim2Real.md)
...
- **2022** — RT-1 (Google) — 35M 参数,Transformer-based,5000 demonstrations
...
| **π0** | Physical Intelligence 2024 | PaliGemma + Flow Matching | 3B, 流模型解码 |
...
- **同节**：[VLA 模型综述](VLA模型.md)、[多模态学习](../../03_Foundation_Models/05_Multimodal/多模态学习.md)
- **机器人学习**：[Diffusion Policy](../04_Robot_Learning/扩散策略.md)、[模仿学习](../04_Robot_Learning/模仿学习.md)、[Sim2Real](../04_Robot_Learning/Sim2Real.md)
- **基础**：[LLM](../../03_Foundation_Models/03_Language_Models/LLM_as_Foundation.md)、[CLIP](../../03_Foundation_Models/04_Vision_Foundation/CLIP.md)
