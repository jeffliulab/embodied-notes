...
> *Model Predictive Control (MPC) — 经典控制理论的现代主力。**每个时刻向未来推演 H 步,优化序列动作,只执行第一步,然后下一步重做**。Tesla Autopilot, Boston Dynamics, SpaceX 火箭都用 MPC。与 [MDP](../../01_AI/01_Classical_AI/04_Planning/MDP.md) 是 finite-horizon vs infinite-horizon 关系。*
>
> **难度**：Intermediate-Advanced
> **前置知识**：[控制理论](控制理论.md)、[运动规划](../../01_AI/01_Classical_AI/04_Planning/motion_trajectory_planning.md)、[MDP](../../01_AI/01_Classical_AI/04_Planning/MDP.md)、最优化基础
> **后续阅读**：[Dreamer](../../04_Reinforcement_Learning/04_Modern_RL/Dreamer.md)（Model-based RL）、[Diffusion Policy](../04_Robot_Learning/扩散策略.md)
...
- **同节**：[控制理论](控制理论.md)（PID/LQR 基础）、[运动规划](../../01_AI/01_Classical_AI/04_Planning/motion_trajectory_planning.md)
- **理论**：[MDP](../../01_AI/01_Classical_AI/04_Planning/MDP.md)（无限 horizon 版）、最优化理论
- **RL 联系**：[Dreamer](../../04_Reinforcement_Learning/04_Modern_RL/Dreamer.md)（学 model 后做 MPC）、[AlphaZero](../../04_Reinforcement_Learning/04_Modern_RL/AlphaZero_Family.md)（MCTS 是 MPC 的搜索版）
