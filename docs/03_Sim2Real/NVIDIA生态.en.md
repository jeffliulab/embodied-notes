...
If your question is not about the USD API itself but about how USD carries robots, objects, materials, scenes, and sensors as simulation assets, continue with [Simulation Assets](仿真资产.en.md).
...
For a more systematic discussion of world randomization, timing, sensor rules, and contact tuning, see [Simulation World Building & Physics Rules](仿真世界构建与物理规则.en.md) and [Sim2Real](../04_Robot_Learning/Sim2Real.en.md).
...
For more on reinforcement learning combined with robotics, see [Reinforcement Learning in Robotics](../04_Robot_Learning/强化学习在机器人中的应用.en.md).
...
For more on world models, see [World Models and Video Generation](../05_Models/世界模型与视频生成.en.md).
...
For more computing platform details, see [Computing Platforms](../07_Hardware/计算平台.en.md).
...
- Related notes: [Simulation Platforms](simulation_platforms.en.md) | [Simulation Assets](仿真资产.en.md) | [Simulation World Building & Physics Rules](仿真世界构建与物理规则.en.md) | [World Models and Video Generation](../05_Models/世界模型与视频生成.en.md) | [Reinforcement Learning in Robotics](../04_Robot_Learning/强化学习在机器人中的应用.en.md) | [Computing Platforms](../07_Hardware/计算平台.en.md)
