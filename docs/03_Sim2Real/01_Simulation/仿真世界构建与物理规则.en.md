...
In [Virtual World Simulation Engines](https://jeffliulab.com/ai-notes/05_AI_Agents/07_Virtual_Embodied_Agents/虚拟世界仿真引擎), the Smallville example looks like social simulation, not robotics. But it demonstrates an important engineering idea: a world is not just an image or a mesh. It is a semantic tree.
