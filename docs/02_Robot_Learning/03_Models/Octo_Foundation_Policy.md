...
>
> **难度**:Advanced
> **前置知识**:[VLA 模型](../01_Foundations/VLA模型.md)、[RT-2 / OpenVLA](RT2_OpenVLA.md)、[Diffusion Policy](../02_Methods/扩散策略.md)
...
- **同节**:[VLA 模型](../01_Foundations/VLA模型.md)、[RT-2 / OpenVLA](RT2_OpenVLA.md)、[π0](Pi0_Physical_Intelligence.md)、[RDT-1B](RDT_1B.md)、[ACT 模型](../02_Methods/ACT模型.md)
