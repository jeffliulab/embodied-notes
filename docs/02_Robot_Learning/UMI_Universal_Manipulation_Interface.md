...
>
> **难度**:Intermediate
> **前置知识**:[VLA 模型](VLA模型.md)、[Diffusion Policy](../04_Robot_Learning/扩散策略.md)、[遥操作](../04_Robot_Learning/遥操作与数据收集.md)
...
- **同节**:[VLA 模型](VLA模型.md)、[DROID Dataset](DROID_Dataset.md)、[Aloha](Aloha_Mobile_Aloha.md)、[π0](Pi0_Physical_Intelligence.md)
- **数据收集**:[遥操作与数据收集](../04_Robot_Learning/遥操作与数据收集.md)
- **方法**:[Diffusion Policy](../04_Robot_Learning/扩散策略.md)、[模仿学习](../04_Robot_Learning/模仿学习.md)
