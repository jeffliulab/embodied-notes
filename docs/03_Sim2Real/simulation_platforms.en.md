...
| How do URDF / MJCF / SDF / USD and related tools work? | [Development Toolchain](开发工具链.en.md) |
| How should I think about transfer and randomization? | [Sim2Real](../04_Robot_Learning/Sim2Real.en.md) |
...
- URDF / MJCF / SDF / USD formats and developer tooling: [Development Toolchain](开发工具链.en.md)
- NVIDIA-specific platforms and models: [NVIDIA Robotics Ecosystem](NVIDIA生态.en.md)
- ROS2 engineering stack: [ROS2](ROS2.en.md)
