...
- **Simulation platforms**: [Simulation Platforms](../../03_Sim2Real/01_Simulation/simulation_platforms.en.md) provides detailed introductions to simulators such as Isaac Gym/Lab and MuJoCo
- **Reinforcement learning**: [Reinforcement Learning in Robotics](强化学习在机器人中的应用.md) details RL training methods in simulation
- **Deployment practice**: [Real-world Deployment](../../03_Sim2Real/index.md) covers engineering details of Sim2Real deployment
- **Control theory**: [Robotics Fundamentals](../../00_Robotics/02_Classical_Robotics/robotics_intro.md) provides safety guarantees from control theory for Sim2Real
