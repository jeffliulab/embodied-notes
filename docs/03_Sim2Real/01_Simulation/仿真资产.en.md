...
| URDF/MJCF/SDF/USD syntax | Not a syntax tutorial | [Development Toolchain](../03_Ecosystem/开发工具链.en.md) |
| Dynamics and control theory | Referenced only when asset parameters depend on them | [Control Theory](../../00_Robotics/02_Classical_Robotics/控制理论.en.md), [Dynamics](../../00_Robotics/02_Classical_Robotics/动力学.en.md) |
| Sim2Real | Discussed from the asset perspective | [Sim2Real](../../02_Robot_Learning/02_Methods/Sim2Real.en.md) |
...
For [Sim2Real](../../02_Robot_Learning/02_Methods/Sim2Real.en.md), materials should support:
...
[Development Toolchain](../03_Ecosystem/开发工具链.en.md) introduces `<link>`, `<joint>`, `<inertial>`, and `<sensor>` from a format perspective. The asset question is different:
...
- For URDF/MJCF/SDF syntax and surrounding toolchains, see [Development Toolchain](../03_Ecosystem/开发工具链.en.md).
- For how assets are assembled into trainable worlds, see [Simulation World Building & Physics Rules](仿真世界构建与物理规则.en.md).
- For why material, lighting, and sensor variability matter in transfer, see [Sim2Real](../../02_Robot_Learning/02_Methods/Sim2Real.en.md).
- For the link between robot assets and control interfaces, see [Control Theory](../../00_Robotics/02_Classical_Robotics/控制理论.en.md).
