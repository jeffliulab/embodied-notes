...
- **Imitation learning**: [Imitation Learning](../02_Methods/模仿学习.md) is the primary consumer of teleoperation data
- **Diffusion policy**: [Diffusion Policy](../02_Methods/扩散策略.md) and other advanced algorithms have higher requirements for data quality and diversity
- **Hardware**: [Hardware Platforms](../../01_Robot_Engineering/15_Hardware_Overview/计算平台.md) introduces the physical infrastructure for data collection including robot arms and sensors
