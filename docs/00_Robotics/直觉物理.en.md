...
In the article on [the brain's prior knowledge](../../01_AI/03_Frontiers/02_Neuroscience/大脑的先验知识.md), we discussed the core source of the human brain's learning efficiency:
