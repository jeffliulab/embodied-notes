...
[虚拟世界仿真引擎](https://jeffliulab.com/ai-notes/05_AI_Agents/07_Virtual_Embodied_Agents/虚拟世界仿真引擎) 里的 Smallville 看似是社会仿真，不是机器人平台，但它有一个非常重要的工程思想：**世界不是一张图，而是一棵带语义的树。**
