...
>
> **Difficulty**: Advanced
> **Prerequisites**: [VLA Models](VLA模型.en.md), [Diffusion Policy](../04_Robot_Learning/扩散策略.en.md), [RT-2 / OpenVLA](RT2_OpenVLA.en.md)
...
- **Same section**: [VLA Models](VLA模型.en.md), [Octo](Octo_Foundation_Policy.en.md), [π0](Pi0_Physical_Intelligence.en.md), [Helix](Helix_Figure_AI.en.md), [RT-2 / OpenVLA](RT2_OpenVLA.en.md)
