...
> For detailed discussion of AI Agents (task-oriented software agents), please refer to the [AI Agents](https://jeffliulab.github.io/ai-notes/05_AI_Agents/) section of this site.
...
> For detailed theoretical exploration of 4E cognition, see [Embodied Cognition Theory](具身认知理论.md).
...
> For detailed theoretical discussion of world models, see [Representations and World Models](表征与世界模型.md). For model and algorithm implementations, see [World Models](../../02_Robot_Learning/01_Foundations/世界模型与视频生成.md).
...
> For detailed planning theory, see [Task and Motion Planning Theory](../02_Classical_Robotics/任务与运动规划理论.md).
...
> For robotics fundamentals (kinematics, dynamics, control), see [Robotics Fundamentals](../index.md).
...
> See the [Robot Learning](../../02_Robot_Learning/index.md) section for details.
...
> See the [Models and Algorithms](../../02_Robot_Learning/03_Models/index.md) section for details.
...
> See [Sim2Real](../../02_Robot_Learning/02_Methods/Sim2Real.md) and [Real-World Deployment](../../03_Sim2Real/index.md) for details.
...
> See [Teleoperation and Data Collection](../../02_Robot_Learning/04_Data_Benchmarks/遥操作与数据收集.md) for details.
...
> See [Robot Forms](../../08_Humanoids/index.md) and [Hardware](../../01_Robot_Engineering/index.md) for details.
...
> See [AI Agents — Virtual Embodied Agents](https://jeffliulab.github.io/ai-notes/05_AI_Agents/07_Virtual_Embodied_Agents/) section for details.
...
| **[Theory](https://jeffliulab.github.io/ai-notes/02_Theory/)** | Embodied cognition, perception-action loops, world model theory, paper readings | Researchers |
| **[Robotics Fundamentals](../index.md)** | Kinematics, dynamics, motion planning, control, SLAM | Learners |
| **[Robot Learning](../../02_Robot_Learning/index.md)** | Imitation learning, RL, Sim2Real, diffusion policy, data collection | Algorithm researchers/engineers |
| **[Models and Algorithms](../../02_Robot_Learning/03_Models/index.md)** | VLA, world models, foundation models, open-source models | Algorithm researchers |
| **[Simulation & Software Development](../../03_Sim2Real/index.md)** | Simulation platforms, simulation assets, world building, ROS2, NVIDIA ecosystem, dev frameworks | Engineers |
| **[Hardware](../../01_Robot_Engineering/index.md)** | Sensors, actuators, compute platforms, open-source hardware | Hardware engineers |
| **[Robot Forms](../../08_Humanoids/index.md)** | Humanoid, quadruped, dexterous hands, drones | Everyone |
| **[Deployment](../../03_Sim2Real/index.md)** | Sim2Real deployment, safety, calibration, real-time systems | Engineers |
| **[Industry](../../09_Topics/index.md)** | Company landscape, market research, industry trends | Industry observers |

Additionally, this site has sections closely related to embodied intelligence:

* **[AI Agents](https://jeffliulab.github.io/ai-notes/05_AI_Agents/)**: Software-level agent technologies, intersecting with embodied intelligence's high-level planning
* **[Reinforcement Learning](https://jeffliulab.github.io/ai-notes/04_Reinforcement_Learning/01_Overview/强化学习全景/)**: One of the core learning paradigms for embodied intelligence
* **[Deep Learning](https://jeffliulab.github.io/ai-notes/02_Deep_Learning/01_Intro/深度学习全景/)**: Foundation models, visual encoders, and other underlying technologies
* **[Robot Engineering](../../01_Robot_Engineering/index.md)**: More engineering-practice-oriented robotics technical details
