...
>
> **难度**:Intermediate
> **前置知识**:[VLA 模型](VLA模型.md)、[模仿学习](../04_Robot_Learning/模仿学习.md)
> **后续阅读**:[Open X-Embodiment](数据集与Benchmark.md)、[π0](Pi0_Physical_Intelligence.md)
...
- **同节**:[VLA 模型](VLA模型.md)、[Octo](Octo_Foundation_Policy.md)、[π0](Pi0_Physical_Intelligence.md)、[数据集与 Benchmark](数据集与Benchmark.md)
- **数据收集**:[遥操作与数据收集](../04_Robot_Learning/遥操作与数据收集.md)、[UMI](UMI_Universal_Manipulation_Interface.md)
