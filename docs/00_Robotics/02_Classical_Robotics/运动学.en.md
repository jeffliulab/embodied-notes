...
Humanoid robots (see [Humanoid Robots](../../08_Humanoids/humanoid_robot.md)) have highly redundant tree-structured kinematic chains. Their kinematic analysis requires:
