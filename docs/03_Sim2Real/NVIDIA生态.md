...
>
> 本文重点是 NVIDIA 生态的定位与栈内关系，不展开做成百科式仿真教程。关于 USD 资产如何制作和导入，见 [仿真资产](仿真资产.md)；关于世界如何组织、随机化以及物理规则如何配置，见 [仿真世界构建与物理规则](仿真世界构建与物理规则.md)。
...
如果你关心的不是 USD API 本身，而是“它如何承载机器人、物体、场景、传感器等仿真资产”，应继续看 [仿真资产](仿真资产.md)。
...
更系统的世界随机化、时间系统、传感器规则和接触调参，请看 [仿真世界构建与物理规则](仿真世界构建与物理规则.md) 与 [Sim2Real](../04_Robot_Learning/Sim2Real.md)。
...
更多强化学习与机器人结合的内容请参阅 [强化学习在机器人中的应用](../04_Robot_Learning/强化学习在机器人中的应用.md)。
...
更多世界模型相关内容请参阅 [世界模型与视频生成](../05_Models/世界模型与视频生成.md)。
...
更多计算平台详情请参阅 [计算平台](../07_Hardware/计算平台.md)。
...
- 相关笔记：[仿真平台](simulation_platforms.md) | [仿真资产](仿真资产.md) | [仿真世界构建与物理规则](仿真世界构建与物理规则.md) | [世界模型与视频生成](../05_Models/世界模型与视频生成.md) | [强化学习在机器人中的应用](../04_Robot_Learning/强化学习在机器人中的应用.md) | [计算平台](../07_Hardware/计算平台.md)
