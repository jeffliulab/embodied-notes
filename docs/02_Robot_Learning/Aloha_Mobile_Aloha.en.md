...
> **Prerequisites**: [ACT Model](ACT模型.en.md), [VLA Models](VLA模型.en.md), [Teleoperation](../04_Robot_Learning/遥操作与数据收集.en.md)
> **Further reading**: [π0](Pi0_Physical_Intelligence.en.md), [UMI](UMI_Universal_Manipulation_Interface.en.md)
...
- **Same section**: [ACT Model](ACT模型.en.md), [VLA Models](VLA模型.en.md), [DROID](DROID_Dataset.en.md), [UMI](UMI_Universal_Manipulation_Interface.en.md), [π0](Pi0_Physical_Intelligence.en.md)
- **Data collection**: [Teleoperation & Data Collection](../04_Robot_Learning/遥操作与数据收集.en.md)
- **Robot forms**: [Dual-arm Robots](../08_Robot_Forms/humanoid_robot.en.md)
