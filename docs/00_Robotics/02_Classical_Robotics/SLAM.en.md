...
LiDAR SLAM uses laser scanners to obtain precise 3D point clouds (see [Sensors](../../01_Robot_Engineering/15_Hardware_Overview/传感器.md)), suitable for large-scale outdoor environments.
...
SLAM systems typically run under the ROS/ROS2 framework (see [ROS2](../../03_Sim2Real/03_Ecosystem/ROS2.md)), coordinating with the navigation stack:
...
Sensor selection and calibration are crucial for SLAM performance (see [Sensors](../../01_Robot_Engineering/15_Hardware_Overview/传感器.md)).
