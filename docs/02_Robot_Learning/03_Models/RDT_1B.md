...
>
> **难度**:Advanced
> **前置知识**:[VLA 模型](../01_Foundations/VLA模型.md)、[Diffusion Policy](../02_Methods/扩散策略.md)、[RT-2 / OpenVLA](RT2_OpenVLA.md)
...
- **同节**:[VLA 模型](../01_Foundations/VLA模型.md)、[Octo](Octo_Foundation_Policy.md)、[π0](Pi0_Physical_Intelligence.md)、[Helix](Helix_Figure_AI.md)、[RT-2 / OpenVLA](RT2_OpenVLA.md)
- **数据**:[Open X-Embodiment](../04_Data_Benchmarks/数据集与Benchmark.md)
- **学习方法**:[Diffusion Policy](../02_Methods/扩散策略.md)、[模仿学习](../02_Methods/模仿学习.md)
