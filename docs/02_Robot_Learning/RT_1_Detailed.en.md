...
> **Prerequisites**: [VLA Models](VLA模型.en.md), [Transformer](../../02_Deep_Learning/05_Transformers/transformer_architect.en.md), [Imitation Learning](../04_Robot_Learning/模仿学习.en.md)
...
- **Same section**: [VLA Models](VLA模型.en.md), [RT-2 / OpenVLA](RT2_OpenVLA.en.md), [π0](Pi0_Physical_Intelligence.en.md), [Octo](Octo_Foundation_Policy.en.md), [Helix](Helix_Figure_AI.en.md)
- **Basics**: [Transformer](../../02_Deep_Learning/05_Transformers/transformer_architect.en.md), [Imitation Learning](../04_Robot_Learning/模仿学习.en.md)
- **Data**: [Open X-Embodiment](数据集与Benchmark.en.md)
