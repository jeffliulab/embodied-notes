...
- [Teleoperation and Data Collection](../../02_Robot_Learning/04_Data_Benchmarks/遥操作与数据收集.md) - Data collection methodologies for each platform
- [Dexterous Hands](../../06_Robot_Arms/灵巧手.md) - In-depth discussion of LEAP Hand and other dexterous hands
- [Open-Source Frameworks](../../03_Sim2Real/03_Ecosystem/开源框架.md) - Software frameworks like LeRobot
