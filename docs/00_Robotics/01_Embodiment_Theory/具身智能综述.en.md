...
> For detailed discussion of AI Agents (task-oriented software agents), please refer to the [AI Agents](https://jeffliulab.com/ai-notes) section of this site.
...
> See [AI Agents — Virtual Embodied Agents](https://jeffliulab.com/ai-notes) section for details.
...
| **[Theory](https://jeffliulab.com/ai-notes)** | Embodied cognition, perception-action loops, world model theory, paper readings | Researchers |
...
* **[AI Agents](https://jeffliulab.com/ai-notes)**: Software-level agent technologies, intersecting with embodied intelligence's high-level planning
