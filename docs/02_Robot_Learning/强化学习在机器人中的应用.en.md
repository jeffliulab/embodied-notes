...
- **Control theory foundations**: [Robotics Fundamentals](../03_Robotics/robotics_intro.md) covers PID, MPC as complementary methods to RL
- **Sim2Real transfer**: [Sim2Real](Sim2Real.md) details how to deploy RL policies trained in simulation to real environments
- **Simulation platforms**: [Simulation Platforms](../06_Software/simulation_platforms.en.md) introduces Isaac Gym/Lab and other training infrastructure
