...
> This article provides in-depth technical notes on the ROS2 system architecture and key software stacks. For ROS history and basic installation, see the ROS section in [Simulation Platforms](simulation_platforms.en.md).
...
For more on motion planning theory, see [Motion Planning](../03_Robotics/运动规划.en.md).
...
For more SLAM-related content, see [SLAM](../03_Robotics/SLAM.en.md).
...
- Related notes: [Motion Planning](../03_Robotics/运动规划.en.md) | [SLAM](../03_Robotics/SLAM.en.md) | [Development Toolchain](开发工具链.en.md)
