...
> Related notes: [Model Roadmap](模型发展路线图.en.md) | [ACT Model](ACT模型.en.md) | [Imitation Learning](../04_Robot_Learning/模仿学习.en.md) | [Diffusion Policy](../04_Robot_Learning/扩散策略.en.md) | [Foundation Models for Robotics](机器人基础模型概论.en.md) | [Open-Source Model Summary](开源模型汇总.en.md)
...
> More on diffusion policies: [Diffusion Policy](../04_Robot_Learning/扩散策略.md)
...
This design line did not appear out of nowhere. The key bridge model is [ACT Model](ACT模型.en.md): ACT turned chunked action prediction into a reproducible and interpretable policy paradigm, and many later VLA horizon, chunk execution, and temporal smoothing designs inherit intuition from that line.
